...
{
    public class TownEvent_fantasy : MonoBehaviour, IReceiver, IReadyable
    {
        ...
        void Update()
        {
            ...
            {
                // スプライトの動きを設定する
                SpriteAnimeMove("fmame_no", "fmame_no");
                SpriteAnimeMove("fmame_non", "fmame_non");
                SpriteAnimeMove("fmame_yo", "fmame_yo");
                SpriteAnimeMove("fmame_si", "fmame_si");
                SpriteAnimeMove("fmame_siy", "fmame_siy");
        ...
        private void ButtonCloseClick()
        {
            ...
            GEHandler.OnRemoveScene(SceneLabel.TOWN_EVENT + "_fantasy");
        }
        ...
        private void FukidashiTextSet()
        {
            ...
            {
                string[] _name = new string[] { "fuki/Text1", "fuki/Text2", "fuki/Text3" };
                string _mes = "";
