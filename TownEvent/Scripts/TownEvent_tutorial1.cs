...
{
    public class TownEvent_tutorial1 : MonoBehaviour, IReceiver, IReadyable
    {
        ...
        private ApplitchiAnimeTable[] animeFlag = new ApplitchiAnimeTable[3]{
            ApplitchiAnimeTable.DUMMY,ApplitchiAnimeTable.DUMMY,ApplitchiAnimeTable.DUMMY,
        };
        private Coroutine[] retApplitchi = new Coroutine[3]{
            null,null,null,
        };
        ...
        IEnumerator mStart()
        {
            ...
            MainObj.transform.Find("tutorial1/bt_next").gameObject.GetComponent<Button>().onClick.AddListener(PageButtonClick);
            MainObj.transform.Find("tutorial1/bt_back").gameObject.GetComponent<Button>().onClick.AddListener(PageButtonClick);
            MainObj.transform.Find("tutorial1/bt_close").gameObject.GetComponent<Button>().onClick.AddListener(CloseButton1Click);


            MainObj.transform.Find("tutorial1").gameObject.SetActive(true);
        ...
        void Update()
        {
            if (apritchiFLag)
            {
                string[] apri_image_name = new string[] {
                    "tutorial1/fukidasi/apprich", "tutorial1/fukidasi/apprich_l", "tutorial1/fukidasi/apprich_r",
                };
        ...
        private void CloseButton1Click()
        {
            ManagerObject.instance.sound.playSe(17);
            GEHandler.OnRemoveScene(SceneLabel.TOWN_EVENT + "_tutorial1");
        }
