...
{
    public class TownEvent_sanrio2 : MonoBehaviour, IReceiver, IReadyable
    {
        ...
        void Update()
        {
            ...
            {
                // スプライトの動きを設定する
                SpriteAnimeMove("mymelody_no", "mymelody_no");
                SpriteAnimeMove("mymelody_yo", "mymelody_yo");
                SpriteAnimeMove("mymelody_pu", "mymelody_pu");
        ...
        private void ButtonCloseClick()
        {
            ...
            GEHandler.OnRemoveScene(SceneLabel.TOWN_EVENT + "_sanrio2");
        }
        ...
        {
            if (EventBase.transform.Find("fuki_mymelody").gameObject.activeSelf)
            {
                string[] _name = new string[] { "fuki_mymelody/Text1", "fuki_mymelody/Text2", "fuki_mymelody/Text3" };
                string _mes = "";

                EventScene.transform.Find("fuki_mymelody").gameObject.SetActive(true);
                ...
                EventScene.transform.Find("fuki_mymelody/Text").gameObject.GetComponent<Text>().text = _mes;
            }
            else
            {
                EventScene.transform.Find("fuki_mymelody").gameObject.SetActive(false);
            }
        }
